...
// == сравнивает значение, приводя переменные к одному типу, когда === сравнивает значения, не приводя типы. К примеру, '1' и 1 для == это одинаковые значения, а для === это разные. Также для == false 0 "" [] это одно и тоже